...
namespace Hearts.AI
{
    public interface IAgent
    {
        ...
        IEnumerable<Card> ChooseCardsToPass(Round round, IEnumerable<Card> startingCards, Pass pass); // TODO: Add player I'm passing to, Add player I'm receiving from, Add Game history, e.g. scores
